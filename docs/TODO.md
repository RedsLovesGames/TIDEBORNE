...
- [x] Remove high-confidence dead legacy implementation while preserving required migration reads, remove the obsolete FishScore self-mixin and inactive Satchel mixin source, and document ownership of the historical package split without a broad rewrite. See `docs/ARCHITECTURE.md`.
