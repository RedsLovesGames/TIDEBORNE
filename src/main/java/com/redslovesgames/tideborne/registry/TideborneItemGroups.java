...
public final class TideborneItemGroups {
 ...
 public static synchronized void init(){if(initialized)return;initialized=true;Registry.register(Registries.ITEM_GROUP,TIDEBORNE_ID,TIDEBORNE);} public static List<Item> currentCreativeItems(){return creativeItems(FishingGameplayInitializer.isMythsIntegrationActive(),FishingGameplayInitializer.isApexIntegrationActive());}
