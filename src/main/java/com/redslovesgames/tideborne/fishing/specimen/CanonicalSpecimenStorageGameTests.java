...
public final class CanonicalSpecimenStorageGameTests implements FabricGameTest {
    ...
    public void teamCatchRetainsCanonicalSpecimenAcrossNestedClearOnly(TestContext helper) {
        ...
        com.redslovesgames.tideborne.journal.TeamProgressStore.tideborneBeginCatch(stack);
        helper.assertTrue(com.redslovesgames.tideborne.journal.TeamProgressStore.tideborneCurrentFishScore()
                == specimen().fishScore().orElseThrow(), "Catch score differs from canonical specimen");
        com.redslovesgames.tideborne.journal.TeamProgressStore.tideborneClearCatch();
        helper.assertTrue(com.redslovesgames.tideborne.journal.TeamProgressStore.tideborneCurrentFishScore() == -1,
                "Cleared catch retained current score");
        com.redslovesgames.tideborne.journal.TeamProgressStore.tideborneRecordCurrentTopFish(root, id, "angler");
        ...
        com.redslovesgames.tideborne.journal.TeamProgressStore.tideborneRecordCurrentTopFish(nextRoot, java.util.UUID.randomUUID(), "next");
