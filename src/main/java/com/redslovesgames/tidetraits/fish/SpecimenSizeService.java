...
public final class SpecimenSizeService {
   ...
   public SpecimenSizeService.AppliedSize applyNew(
      ...
      if (!sizeData.isEmpty() && isUsablePhysicalLength(tideNormalLengthCm)) {
         ...
         // The 1.3.57 bytecode's synthetic enum switch maps only DWARF, GIANT,
         // and PARASITE_RIDDEN to reachable cases. Preserve that behavior here;
         // the decompiler emitted an unreachable fourth synthetic case.
