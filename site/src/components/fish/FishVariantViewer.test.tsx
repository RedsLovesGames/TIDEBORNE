...
describe('FishVariantViewer', () => {
  it('switches between verified local render variants and exposes the active state', () => {
    render(
      <FishVariantViewer
    ...
    expect(screen.getByRole('img').getAttribute('src')).toBe('/TIDEBORNE/fish/renders/dragon.png');
    ...
    expect(screen.getByRole('img').getAttribute('src')).toBe('/TIDEBORNE/fish/renders/dragon_giant.png');
